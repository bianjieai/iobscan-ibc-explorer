            ...
            <div class="transfer_detail_top_content">
                ...
                <div class="transfer_ibc_out_tx_hash">
                    <span class="transfer_ibc_out_tx_hash_label">
                        ...
                        <i v-show="outTxStatus === 1" style="color: rgba(0, 200, 83, 1)"
                ...
                <div class="transfer_arrows_icon">
                    <i v-show="ibcTxStatus === 1" style="color: rgba(0, 200, 83, 1)"
                        class="iconfont_style iconfont icon-zhuangtai"></i>
                    <i v-show="ibcTxStatus === 2 || ibcTxStatus === 4" style="color: rgba(255, 90, 90, 1)"
                        class="iconfont_style iconfont icon-zhuangtai"></i>
                    <i v-show="ibcTxStatus === 3" style="color: rgba(255, 196, 0, 1)"
                        class="iconfont_style iconfont icon-zhuangtai"></i>
                    <i v-show="ibcTxStatus === 'default'" style="color: rgba(0, 0, 0, 0.35)"
                        class="iconfont_style iconfont icon-zhuangtai"></i>
                </div>
                <div class="transfer_ibc_in_tx_hash">
                    <span class="transfer_ibc_in_tx_hash_label">
                        ...
                        <i v-show="inTxStatus === 1" style="color: rgba(0, 200, 83, 1)"
                            class="iconfont icon-address1"></i>
